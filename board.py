import pygame
from .constants import BLACK, ROWS, SQUARE_SIZE, COLUMNS, WHITE
...
class Board:
    ...
    def get_valid_moves(self, piece):
        moves = {}
        # a key is a valid position, a value is the position of pieces that have to be removed after the move is done
        left = piece.col - 1
        right = piece.col + 1
        row = piece.row
        
        #print ("x = {}, y = {}".format(piece.col, row))
